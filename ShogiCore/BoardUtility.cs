...
namespace ShogiCore {
    ...
    public static unsafe partial class BoardUtility {
        ...
        /// Array.IndexOf()
        /// </summary>
        public static int IndexOf(Piece[] board, Piece value, int startIndex, int count) {
            return Array.IndexOf(board, value, startIndex, count);
        }
        ...
        public static int IndexOf(Piece* board, Piece value, int startIndex, int count) {
            for (int i = 0; i < count; i++) {
                if (board[startIndex + i] == value) return startIndex + i;
            }
            return -1;
        }
        ...
        /// 配列にコピー
        /// </summary>
        public static Piece[] CopyToArray(Piece[] board) {
            return Utility.Clone(board);
        }
        /// <summary>
        /// 配列にコピー
        /// </summary>
        public static Piece[] CopyToArray(Piece* board) {
            Piece[] copy = new Piece[Board.BoardLength];
            Utility.CopyMemory(copy, board, sizeof(Piece) * Board.BoardLength);
            return copy;
        }

        // RPrep:Begin:\[\]	*
        // RPrep:Line:using System;
        // RPrep:Line:using System.Collections.Generic;
        // RPrep:Line:using System.Linq;
        // RPrep:Line:using System.Text;
        // RPrep:Line:using System.Diagnostics;
        // RPrep:Line:
        // RPrep:Line:namespace ShogiCore {
        // RPrep:Line:  /// <summary>
        // RPrep:Line:  /// Pieceの配列に対する処理とか。
        // RPrep:Line:  /// </summary>
        // RPrep:Line:  public static unsafe partial class BoardUtility {
        /// <summary>
        /// スタート位置からまっすぐ検索
        /// </summary>
